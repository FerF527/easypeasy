...
• Preguntas Frecuentes`)
        ...
        case '/mas-votadas':
            ...
            res.write('\n\n');
            let rating = [];
            masVotadas.forEach(function(peli){
            ...
            let ratingMasVotadas = promedio(sumaRating, rating);
            res.write('Rating promedio: ' + ratingMasVotadas);
            res.write('\n\n');
            res.write('Listados de películas.');
            res.write('\n\n');
            masVotadas.forEach(function(peli){
        ...
        case '/sucursales':
            ...
            theaters.forEach(function(teatro){
                res.write('Nombre: ' + teatro.name + '\n')
                res.write('Dirección: ' + teatro.address + '\n')
                res.write('Descripción: ' +teatro.description + '\n\n');
            })
            res.end();
            break;
        case '/contacto':
...
`);         res.write('Listados de preguntas. \n\n');
            faqs.forEach(function(pregunta){
